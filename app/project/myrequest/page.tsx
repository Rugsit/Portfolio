      ...
      <div className="w-full max-w-[700px] mx-auto p-6">
        ...
        <div className="bg-white rounded-lg flex flex-col mb-8">
          ...
          <div className="p-7 text-black">
            <p className="">
              <span className="font-bold">Description:</span> The program's
              primary objective is to facilitate users in managing requests
              efficiently. It enables users to submit requests and access
              request-related information easily and conveniently. The system
              covers all aspects of the request process, from creation to
            ...
            <div className="flex flex-col gap-4">
              <img src="/myrequest/myrequest_1.jpg" />
              <img src="/myrequest/myrequest_2.jpg" />
              <img src="/myrequest/myrequest_3.jpg" />
              <img src="/myrequest/myrequest_4.jpg" />
            </div>
          </div>
        </div>
      </div>
