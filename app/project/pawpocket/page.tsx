        ...
        <div className="bg-white rounded-lg flex flex-col mb-8">
          ...
          <div className="p-7 text-black">
            ...
            <div className="flex flex-col gap-4">
              <Image alt="image" src="/pawpocket/1.jpg" />
              <Image alt="image" src="/pawpocket/2.jpg" />
              <Image alt="image" src="/pawpocket/3.jpg" />
              <Image alt="image" src="/pawpocket/4.jpg" />
              <Image alt="image" src="/pawpocket/5.jpg" />
              <Image alt="image" src="/pawpocket/6.jpg" />
              <Image alt="image" src="/pawpocket/7.jpg" />
              <Image alt="image" src="/pawpocket/8.jpg" />
              <Image alt="image" src="/pawpocket/9.jpg" />
            </div>
          </div>
        </div>
      </div>
